...
function Rental{
    ...
    calculateRentalDuration(){
      let duration= this.rentalStartDate .getTime() - this.rentalEndDate.getTime()
      const rentalDuration = Math.ceil(timeDifference / (1000 * 3600 * 24));
...
const rental = new Rental(car, "Yekebedi", new Date("2023-05-01"), new Date("2023-05-05"));
...
// Create a car object
const cars = new Car("Toyota", "Camry", 2020, true);


const rentals = new Rental(car, "Yekebedi", new Date("2023-05-01"), new Date("2023-05-05"));

const rentalsDuration = rental.calculateRentalDuration();
